...
import co.com.training.beans.task1.AppConfigurationTask1;
...
/**
 *Clase que no usa la coniguracion por xml sino que va por la configuración directa desde java
 */
public class Task1AnnotationsSinXml {
